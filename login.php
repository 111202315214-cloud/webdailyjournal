...
// LOGIKA: Jika SUDAH login (isset), maka jangan kasih halaman login lagi, langsung ke admin
...
<html lang="en">
  <head>
    ...
    <title>My Daily Journal | Login</title>
    <link
  ...
  <body style="background-color: #99d8f8;">
