...
// LOGIKA: Jika BELUM login (!isset), lempar ke halaman login
  ...
  <body>
    ...
    <footer class="text-center p-3 bg-primary-subtle">
			<div>
				...
				<a href="https://wa.me/+6281321263221"><i class="bi bi-whatsapp h2 p-2 text-dark"></i></a>
			</div>
			<div>Aliza Izet Bighoviq &copy; 2023</div>
    </footer>
    <!-- footer end -->
